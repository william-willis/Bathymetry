...
ret = readbty3dplot('C:\Users\agc26\Downloads\Ocean_EGR-master\Ocean_EGR-master\3d\Weymouth3D.bty');
...
[Y,Xf,Af] = sim(net,audioread('C:\Users\agc26\Downloads\Ocean_EGR-master\Ocean_EGR-master\3d\copy_of_420_Weymouth3D_rts_Rd_1_Rr_1.wav'));
figure(1); 
...
X = readbty3d('Weymouth3D.bty');
%[Y1,Xf,Af] = sim(net,audioread('flat_m_100000_10_Pos1_rts_Rd_1_Rr_1.wav'))
[Y1,Xf,Af] = sim(net,audioread('copy_of_420_Weymouth3D_rts_Rd_1_Rr_1.wav'))
