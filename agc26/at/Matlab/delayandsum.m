...
T = 2.0;     % time window to capture %alex edit reduced from 10 to 2 11/13
%sample_rate = 1000;
sample_rate = 100000;
...
% Alex edit to remove above generated by cans
...
%xlabel( 'Time (s)' )
%ylabel( 's^+(t)' )
% Alex edit removed stupid pop up picture
%%
% Main routine:
% read the arrivals file and convolve with the source waveform

% Alex edit to add stuff
c = 1537.0;
T = 5.0;
% Alex edit done
